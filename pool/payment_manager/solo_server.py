...
from pool.payment_manager.solo import SoloPaymentManager
...
class PaymentServer:
    def __init__(
        ...
        initialize_logging(
            "pplns_payment", pool_config["PPLNS_logging"], pathlib.Path(pool_config["PPLNS_logging"]["log_path"])
        )
        ...
        self.payment_manager: AbstractPaymentManager = server_name or SoloPaymentManager(
